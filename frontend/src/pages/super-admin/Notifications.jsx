...
import {
  Bell, BellOff, CheckCheck, Building2, AlertTriangle,
  MessageSquare, Users, Clock, ShieldCheck, ShieldX, ShieldBan, ShieldPlus,
} from 'lucide-react';
...
const iconMap = {
  ...
  COMPANY_SUSPENDED: ShieldBan,
  COMPANY_REACTIVATED: ShieldPlus,
...
export default function SANotifications() {
  ...
  const { resetUnreadCount } = useOutletContext() || {};
  ...
  const markReadMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries(['sa-notifications']);
    },
  });
