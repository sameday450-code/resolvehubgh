    ...
    <div className="min-h-screen bg-gradient-to-b from-background via-background to-muted/30 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <motion.h1 variants={fadeUp} className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-6 leading-tight text-white drop-shadow-lg">
                Capture Every Complaint.{' '}
                <span className="text-yellow-300 drop-shadow-lg">
                  Across Every Location.
                </span>
              </motion.h1>
              <motion.p variants={fadeUp} className="text-lg md:text-xl text-white/90 leading-relaxed max-w-3xl mx-auto mb-10 font-light drop-shadow-md">
      ...
      <section className="py-20 md:py-32 bg-gradient-to-b from-muted/30 to-muted/60 relative overflow-hidden">
        <div className="container mx-auto px-4">
          ...
          >
            <motion.h2 variants={fadeUp} className="text-4xl md:text-5xl font-bold mb-4">Our Mission & Vision</motion.h2>
      ...
      <section className="py-20 md:py-32">
        <div className="container mx-auto px-4">
          ...
          >
            <motion.h2 variants={fadeUp} className="text-4xl md:text-5xl font-bold mb-4">Our Core Values</motion.h2>
            <motion.p variants={fadeUp} className="text-muted-foreground text-lg max-w-2xl mx-auto">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto">
            <motion.div
              ...
              className="text-center mb-16"
            >
              <motion.h2 variants={fadeUp} className="text-4xl md:text-5xl font-bold mb-2">Founder &amp; CEO</motion.h2>
              <motion.p variants={fadeUp} className="text-muted-foreground text-lg">The vision behind ResolveHub</motion.p>
              <motion.div variants={fadeIn} className="h-1 w-16 bg-gradient-to-r from-primary to-blue-600 rounded-full mx-auto mt-4" />
            </motion.div>
      ...
      <section className="py-20 md:py-32">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            className="text-center mb-20"
          >
            <motion.h2 variants={fadeUp} className="text-4xl md:text-5xl font-bold mb-4">Our Leadership Team</motion.h2>
            <motion.p variants={fadeUp} className="text-muted-foreground text-lg max-w-2xl mx-auto">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <motion.div
              ...
              className="text-center mb-20"
            >
              <motion.h2 variants={fadeUp} className="text-4xl md:text-5xl font-bold mb-4">Our Journey</motion.h2>
            ...
            >
              ...
              {[
                ...
                <motion.div key={i} variants={staggerItem} className="flex gap-6 md:gap-0 relative md:mb-12">
