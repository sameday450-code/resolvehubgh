...
// Read operations
router.get('/', authenticate, authorize('COMPANY_ADMIN'), tenantGuard, dashboardLockGuard, billingGuard('read'), controller.getSettings);
router.get('/categories', authenticate, authorize('COMPANY_ADMIN'), tenantGuard, dashboardLockGuard, billingGuard('read'), controller.getCategories);
router.get('/staff', authenticate, authorize('COMPANY_ADMIN'), tenantGuard, dashboardLockGuard, billingGuard('read'), controller.getStaff);
...
// Delete operations
router.delete('/categories/:id', authenticate, authorize('COMPANY_ADMIN'), tenantGuard, dashboardLockGuard, billingGuard('delete'), controller.deleteCategory);
